...
\begin{itemize}
\item \emph{Developed quasar absorber finder, \href{https://github.com/abhi0395/qsoabsfind}{qsoabsfind}, studied gas distribution in CGM/ICM of galaxies and clusters using SDSS and DESI.}
\end{itemize}
...
\begin{list}{}{\cvlist}
    ...
    \item Active mentor in DESI mentorship program.
