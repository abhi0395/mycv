...
\textsf{\small AbhijeetAnand@lbl.gov, \href{https://www.mpa-garching.mpg.de/~abhijeet/}{https://www.mpa-garching.mpg.de/\string~abhijeet/}}\\[0.5ex]

\subsection{Positions}
\begin{list}{}{\cvlist}
\item Sep'22 - present: Postdoctoral Scientist, Lawrence Berkeley National Lab, Berkeley, CA, USA \\
\begin{itemize}
  \item[] Group: \href{https://www.desi.lbl.gov/}{Dark Energy Survey Instrument (DESI)}, Supervisor: Dr. Julien Guy
  \item[] Improving redshift estimation algorithm for DESI galaxes, using DESI spectra to characterize cool/warm gas in galactic halo
\end{itemize}
