...
Sep'22 - Aug'25: Postdoctoral Scientist, Lawerence Berkeley National Lab (LBNL), Berkeley, CA, USA
    Team: \href{}{Dark Energy Survey Instrument (DESI)}
\item
...
\begin{list}{}{\cvlist}
  ...
  \item Collaboration ---
    ...
    \item Member \& contributor (github repo) ---
        \href{https://github.com/desihub/redrock}{redrock}: Redshift fitting for spectroperfectionism.
        \href{https://github.com/desihub}{desihub}: Public code associated with DESI.
 \item Organizer ---
