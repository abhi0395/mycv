...
\begin{itemize}
\item Working as an independent postdoctoral fellow, developing ML and data science methods for astrophysical problems and drafting scientific goals for next generation telescopes.
\end{itemize}
\end{adjustwidth}
\vspace{1.5mm}
...
\textbf{Data Engineering} & SQL, Parallel I/O pipelines (FITS, HDF5), HPC (Slurm, NERSC), Cloud-ready workflow design, Automated schedulers (cron), debugging, dashboards, code optimization and documentation \\
