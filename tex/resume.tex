...
\begin{center}
\vspace*{-1.25mm}
\textit{Astrophysicist and Data Scientist with a PhD in Astrophysics and 6+ years of experience building scalable machine learning models, analytics workflows, and data pipelines for large, complex datasets, including 60M+ records and 5+ TB of data per day. Skilled in Python, SQL, statistical modeling, and predictive analytics, with a strong track record of improving model accuracy, reducing false positives, and delivering production-quality pipelines. Experienced in cross-functional collaboration, open-source software development, and communicating scientific results effectively to diverse audiences.}
