...
\begin{itemize}
\item Working as an independent postdoctoral fellow, developing ML and data science methods for astrophysical problems and designing scientific goals for next generation telescopes.
\end{itemize}
\end{adjustwidth}
\vspace{1.5mm}
